...
import { User, MapPin, Shield, Building2, Lock, ArrowRight, ChevronDown } from "lucide-react";
...
export default function AboutContent() {
  return (
    <>
      ...
      {/* Where Brightwood Sits — AI Value Chain */}
      <section className="py-[100px] lg:py-[140px]">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <FadeIn>
            <h2 className="font-serif text-[36px] md:text-[44px] text-text-primary">
          ...
          <div className="mt-14 max-w-3xl mx-auto">
            {[
              { label: "AI Models", companies: "OpenAI, Anthropic, Google DeepMind, Meta AI, xAI, Mistral, Cohere", highlight: false },
              { label: "Chips & Semiconductors", companies: "Nvidia, AMD, TSMC, Broadcom, Intel, Samsung", highlight: false },
              { label: "Cloud & GPU Compute", companies: "AWS, Azure, Google Cloud, CoreWeave, Iren, Oracle", highlight: false },
              { label: "Data Centres", companies: "NEXTDC, AirTrunk, Equinix, Digital Realty, Goodman, Stack", highlight: false },
              { label: "Power Infrastructure", companies: "BRIGHTWOOD ENERGY", highlight: true },
            ].map((layer, i) => (
              <div key={i}>
                <motion.div
